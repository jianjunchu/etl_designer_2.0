        ...
        if (repNode!=null)
        {
          ...
          try {
          	if(!repositoriesMeta.readData()){
          		//xnren start if can not readData,try to use repBean
            	DatabaseMeta databaseMeta = new DatabaseMeta(BaseHttpServlet.repBean.getRepositoryName(),BaseHttpServlet.repBean.getDbType(),
            			BaseHttpServlet.repBean.getDbAccess(),BaseHttpServlet.repBean.getDbHost(),BaseHttpServlet.repBean.getDbName(),
            			BaseHttpServlet.repBean.getDbPort(),BaseHttpServlet.repBean.getUserName(),BaseHttpServlet.repBean.getPassword());
                RepositoryMeta repositoryMeta = new KettleDatabaseRepositoryMeta(String.valueOf(BaseHttpServlet.repBean.getRepositoryID()),
                		BaseHttpServlet.repBean.getRepositoryName(),BaseHttpServlet.repBean.getDbType(), databaseMeta) ;
