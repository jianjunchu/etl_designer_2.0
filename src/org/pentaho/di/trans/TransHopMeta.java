...
public class TransHopMeta implements Cloneable, XMLInterface, Comparable<TransHopMeta>
{
	...
	public String toString()
	{
		...
		return str_fr + " --> " + str_to + " (" + (enabled ? BaseMessages.getString(PKG,"TransHopMeta.enable") : BaseMessages.getString(PKG,"TransHopMeta.disable")) + ")"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	}
