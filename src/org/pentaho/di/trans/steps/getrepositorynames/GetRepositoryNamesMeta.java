...
public class GetRepositoryNamesMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void getFields(RowMetaInterface row, String origin, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space) throws KettleStepException {
    ...
    //
    ValueMetaInterface object = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.object"), ValueMeta.TYPE_STRING);
    ...
    // the directory
    //
    ValueMetaInterface directory = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.directory"), ValueMeta.TYPE_STRING);
    ...
    // the name
    //
    ValueMetaInterface name = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.name"), ValueMeta.TYPE_STRING);
    name.setLength(500);
    name.setPrecision(-1);
    ...
    // the object type
    //
    ValueMetaInterface objectType = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.object_type"), ValueMeta.TYPE_STRING);
    ...
    // object_id
    //
    ValueMetaInterface objectId = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.object_id"), ValueMeta.TYPE_STRING);
    object.setLength(500);
    object.setPrecision(-1);
    ...
    // modified by
    //
    ValueMetaInterface modifiedBy = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.modified_by"), ValueMeta.TYPE_STRING);
    object.setLength(500);
    object.setPrecision(-1);
    ...
    // modified date
    //
    ValueMetaInterface modifiedDate = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.modified_date"), ValueMeta.TYPE_DATE);
    modifiedDate.setOrigin(origin);
    row.addValueMeta(modifiedDate);
    
    // description
    //
    ValueMetaInterface description = new ValueMeta(BaseMessages.getString(PKG, "GetRepositoryNames.description"), ValueMeta.TYPE_STRING);
