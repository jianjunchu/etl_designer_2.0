  ...
  private boolean parallel;
		...
		throws KettleException
	{
		try
		{
            ...
            rep.saveStepAttribute(id_transformation, id_step, "before_sql",          beforeSQL);    //$NON-NLS-1$
            rep.saveStepAttribute(id_transformation, id_step, "after_sql",          afterSQL);    //$NON-NLS-1$
