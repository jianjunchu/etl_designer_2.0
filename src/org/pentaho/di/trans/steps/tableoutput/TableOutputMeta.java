 ...
 * @since  2-jun-2003
 */
public class TableOutputMeta extends BaseStepMeta implements StepMetaInterface, StepMetaInjectionInterface
{
	...
	private void readData(Node stepnode, List<? extends SharedObjectInterface> databases) throws KettleXMLException
	{
		try
		{
            ...
            beforeSQL = XMLHandler.getTagValue(stepnode, "before_sql");
            afterSQL = XMLHandler.getTagValue(stepnode, "after_sql");            
	...
	public String getXML()
	{
        ...
        retval.append("    "+XMLHandler.addTagValue("before_sql", this.beforeSQL));
        retval.append("    "+XMLHandler.addTagValue("after_sql", this.afterSQL));
	...
	public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException
	{
		try
		{
            ...
            beforeSQL     = rep.getStepAttributeString (id_step, "before_sql"); 
            afterSQL     = rep.getStepAttributeString (id_step, "after_sql");
	...
	public void saveRep(Repository rep, ObjectId id_transformation, ObjectId id_step) throws KettleException
	{
		try
		{
            ...
            rep.saveStepAttribute(id_transformation, id_step, "before_sql",          beforeSQL);
            rep.saveStepAttribute(id_transformation, id_step, "after_sql",          afterSQL);
        ...
        for (StepInjectionMetaEntry entry : metadata) {
          KettleAttributeInterface attr = findAttribute(entry.getKey());
	          ...
	          if (entry.getValueType()!=ValueMetaInterface.TYPE_NONE) {
	            ...
	            if (attr.getKey().equals("table")) { this.tablename = (String) entry.getValue(); } else
	            if (attr.getKey().equals("schema")) { this.schemaName = (String) entry.getValue(); } else
		        if (attr.getKey().equals("truncate")) { this.truncateTable = ((Long)entry.getValue()).intValue() == 1?true:false; }
	            else
	            { 
	...
	public void setBeforeSQL(String text) {
		// TODO Auto-generated method stub
		this.beforeSQL = text;
	}
