...
public class TextFileInputMeta extends BaseStepMeta implements StepMetaInterface, InputFileMetaInterface
{
    ...
    /** Are we use listfile to get the input filenames add by jyhe*/
	...
	public String getXML()
	{
		...
		retval.append("    ").append(XMLHandler.addTagValue("listfileName", listfileName));
	...
	private void readData(Node stepnode) throws KettleXMLException
	{
		try
		{
			...
			listfileName = YES.equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "listfileName"));
		}
		catch (Exception e)
		{
	...
	public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException
	{
		try
		{
			...
			listfileName = rep.getStepAttributeBoolean(id_step, "listfileName");
		}
		catch (Exception e)
		{
	...
	public void saveRep(Repository rep, ObjectId id_transformation, ObjectId id_step) throws KettleException
	{
		try
		{
			...
			rep.saveStepAttribute(id_transformation, id_step, "listfileName", listfileName);
		}
		catch (Exception e)
		{
	...
	/**
	 * Get the listfile status add by jyhe
	 */
	public boolean isUsingListfile()
	{
	    return listfileName;
	}
	
	/**
	 * Set the listfile status add by jyhe
	 */
	public void setUsingListfile(boolean listfile)
	{
