...
public class CalculatorMetaFunction implements Cloneable
{
  ...
  public static final int    CALC_LNG_LAT_POINT_DISTANCE     = 76;
    ...
    public static final String calcLongDesc[] = 
        { 
            ...
            BaseMessages.getString(PKG, "CalculatorMetaFunction.CalcFunctions.LngLatPointDistance")
        };
