...
public class StreamLookupMeta extends BaseStepMeta implements StepMetaInterface
{
    ...
    /** The filed of cache file name need to be updated*/
    private String updateCacheFileName;
    
    /** The filed of cache file name used to lookup*/
    private String searchCacheFileName;
    
    /** Indicate that the lookup stream is from previous step*/
    private boolean isFromStep;
    
    /** Indicate that the lookup stream is from cache file*/
    private boolean isFromCacheFile;
    
    /** Indicate that update cache file according to the lookup stream which is from previous step */
    private boolean isUpdateCacheFile;
	...
	private void readData(Node stepnode) throws KettleXMLException
	{
		try
		{
            ...
            isUpdateCacheFile = "Y".equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "isUpdateCacheFile"));
            isFromCacheFile = "Y".equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "isFromCacheFile"));
            isFromStep = "Y".equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "isFromStep"));
            searchCacheFileName=XMLHandler.getTagValue(stepnode, "searchCacheFileName");
            updateCacheFileName=XMLHandler.getTagValue(stepnode, "updateCacheFileName");
            
            //Add by JYHE Start       
            if(!isFromCacheFile&&!isFromStep)
            {
            	isFromCacheFile=false;
            	isFromStep=true;
            }
            //Add by JYHE End
	...
	public void setDefault()
	{
        ...
        updateCacheFileName=null;
        searchCacheFileName=null;
        isFromStep=true;
        isFromCacheFile=false;
        isUpdateCacheFile=false;
	...
	public String getXML()
	{
        ...
        retval.append("    "+XMLHandler.addTagValue("isUpdateCacheFile", isUpdateCacheFile));
        retval.append("    "+XMLHandler.addTagValue("isFromCacheFile", isFromCacheFile));
        retval.append("    "+XMLHandler.addTagValue("isFromStep", isFromStep));
        retval.append("    "+XMLHandler.addTagValue("searchCacheFileName", searchCacheFileName));
        retval.append("    "+XMLHandler.addTagValue("updateCacheFileName", updateCacheFileName));
	...
	public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException
	{
		try
		{
            ...
            isUpdateCacheFile = rep.getStepAttributeBoolean(id_step, "isUpdateCacheFile");
            isFromCacheFile = rep.getStepAttributeBoolean(id_step, "isFromCacheFile");
            isFromStep = rep.getStepAttributeBoolean(id_step, "isFromStep");
            searchCacheFileName = rep.getStepAttributeString(id_step, "searchCacheFileName");
            updateCacheFileName = rep.getStepAttributeString(id_step, "updateCacheFileName");
	...
	public void saveRep(Repository rep, ObjectId id_transformation, ObjectId id_step) throws KettleException
	{
		try
		{
            ...
            rep.saveStepAttribute(id_transformation, id_step, "isUpdateCacheFile", isUpdateCacheFile);
            rep.saveStepAttribute(id_transformation, id_step, "isFromCacheFile", isFromCacheFile);
            rep.saveStepAttribute(id_transformation, id_step, "isFromStep", isFromStep);
            rep.saveStepAttribute(id_transformation, id_step, "searchCacheFileName", searchCacheFileName);
            rep.saveStepAttribute(id_transformation, id_step, "updateCacheFileName", updateCacheFileName);
	...
	public String getUpdateCacheFileName() {
		return updateCacheFileName;
	}

	public void setUpdateCacheFileName(String updateCacheFileName) {
		this.updateCacheFileName = updateCacheFileName;
	}

	public String getSearchCacheFileName() {
		return searchCacheFileName;
	}

	public void setSearchCacheFileName(String searchCacheFileName) {
		this.searchCacheFileName = searchCacheFileName;
	}
	...
	public void setFromStep(boolean isFromStep) {
		this.isFromStep = isFromStep;
	}

	public boolean isFromCacheFile() {
		return isFromCacheFile;
	}

	public void setFromCacheFile(boolean isFromCacheFile) {
		this.isFromCacheFile = isFromCacheFile;
	}

	public boolean isUpdateCacheFile() {
		return isUpdateCacheFile;
	}

	public void setUpdateCacheFile(boolean isUpdateCacheFile) {
		this.isUpdateCacheFile = isUpdateCacheFile;
	};
}
