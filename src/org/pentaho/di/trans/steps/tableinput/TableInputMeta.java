 ...
 *
 */
public class TableInputMeta extends BaseStepMeta implements StepMetaInterface,StepMetaInjectionInterface
{
          ...
          for (StepInjectionMetaEntry entry : metadata) {
            KettleAttributeInterface attr = findAttribute(entry.getKey());
  	          ...
  	          if (entry.getValueType()!=ValueMetaInterface.TYPE_NONE) {
  	            ...
  	            if (attr.getKey().equals("sql")) { this.sql = (String) entry.getValue(); } else
  	            if (attr.getKey().equals("variableReplacementActive")) { this.variableReplacementActive =  (Boolean) entry.getValue(); } else
  	            { 
