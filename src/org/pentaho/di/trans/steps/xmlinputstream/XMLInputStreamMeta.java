...
{	
	...
	public void getFields(RowMetaInterface r, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space)
	{
		...
		if (includeXmlDataTypeNumericField) {
			ValueMetaInterface vdtn = new ValueMeta(space.environmentSubstitute(xmlDataTypeNumericField), ValueMeta.TYPE_INTEGER);
		...
		if (includeXmlDataTypeDescriptionField) {
			ValueMetaInterface vdtd = new ValueMeta(space.environmentSubstitute(xmlDataTypeDescriptionField), ValueMeta.TYPE_STRING);
			vdtd.setLength(25);
			vdtd.setOrigin(name);
			r.addValueMeta(vdtd);
		}
		...
		if (includeXmlLocationLineField) {
			ValueMetaInterface vline = new ValueMeta(space.environmentSubstitute(xmlLocationLineField), ValueMeta.TYPE_INTEGER);
		...
		if (includeXmlLocationColumnField) {
			ValueMetaInterface vcol = new ValueMeta(space.environmentSubstitute(xmlLocationColumnField), ValueMeta.TYPE_INTEGER);
	...
	public String getXML()
	{
		...
		retval.append("    "+XMLHandler.addTagValue("includeDataTypeDescriptionField", includeXmlDataTypeDescriptionField));
	...
	throws KettleException
	{
		try
		{
			...
			rep.saveStepAttribute(id_transformation, id_step, "includeDataTypeDescriptionField",	includeXmlDataTypeDescriptionField);
			...
			rep.saveStepAttribute(id_transformation, id_step, "includeXmlParentElementIDField",	includeXmlParentElementIDField);
	...
	public void setIncludeXmlDataTypeNumericField(
			boolean includeXmlDataTypeNumericField) {
	...
	public void setIncludeXmlDataTypeDescriptionField(
			boolean includeXmlDataTypeDescriptionField) {
	...
	public void setIncludeXmlLocationColumnField(
			boolean includeXmlLocationColumnField) {
	...
	public void setIncludeXmlParentElementIDField(
			boolean includeXmlParentElementIDField) {
