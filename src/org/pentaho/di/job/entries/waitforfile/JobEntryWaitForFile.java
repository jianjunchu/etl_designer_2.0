    ...
    public Result execute(Result previousResult, int nr)
    {
    	...
    	if (filename!=null)
    	{
    		...
    		try
    		{
    			...
    			if ( iMaximumTimeout == 0 )
    			{
    				if(log.isBasic()) logBasic("Waiting indefinitely for file [" +
    						realFilename + "]");
    			}
    			else
    			{
    				if(log.isBasic()) logBasic("Waiting " + iMaximumTimeout + " seconds for file [" +
    						realFilename + "]");
    			}
