...
package org.pentaho.di.ui.trans.steps.dummytrans;
...
public class DummyTransDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(BaseMessages.getString(PKG, "DummyTransDialog.Shell.Title")); //$NON-NLS-1$
		...
		wlStepname.setText(BaseMessages.getString(PKG, "DummyTransDialog.Stepname.Label")); //$NON-NLS-1$
